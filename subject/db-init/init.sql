...
\restrict 341ZWoOYpMPwloPtqSIi5m3fcS3GLrm8LEa0FXQtOAPiF2edMcKX1euj0epIF85
...
ALTER ROLE readonly_user WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:QdPVXTj9dmvpudYCL5zO+w==$509ruYaDu6X20YtnNwpDb6Iu5JYdAAO1//Kg25p6DwM=:134gm4LvB1v2USouVJjomAVAr/5B19b69T5Ko3ewDy4=';
CREATE ROLE student_exam;
ALTER ROLE student_exam WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:daoRxUQIofLM61qFwjn+xQ==$Mf2P8+pbTGGxgTtN5LSRRskYpT2DpgEWUBZhnRS9AHE=:p++EcrZTJNVNtvnL/aWRetBdTXg+ei6+IyruZBRtNgY=';
...
\unrestrict 341ZWoOYpMPwloPtqSIi5m3fcS3GLrm8LEa0FXQtOAPiF2edMcKX1euj0epIF85
...
\restrict HkPAnZUCgPb2Lji2prQGQiavjitqT4KCgfWoFDcgtZMxzRhlldKvPuybhRKHEoG
...
\unrestrict HkPAnZUCgPb2Lji2prQGQiavjitqT4KCgfWoFDcgtZMxzRhlldKvPuybhRKHEoG
...
\restrict 23qkQc5LT0kW4VuhxxMKGPinySB9TX79aoObKKKLPNLKrXjIgX7V2NZ4muyGJ90
...
--
-- Name: exam; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE exam WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE exam OWNER TO postgres;

\unrestrict 23qkQc5LT0kW4VuhxxMKGPinySB9TX79aoObKKKLPNLKrXjIgX7V2NZ4muyGJ90
\connect exam
\restrict 23qkQc5LT0kW4VuhxxMKGPinySB9TX79aoObKKKLPNLKrXjIgX7V2NZ4muyGJ90
...
--
-- Name: exam_submissions_submission_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.exam_submissions_submission_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.exam_submissions_submission_id_seq OWNER TO postgres;

--
-- Name: exam_submissions_submission_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: exam_questions question_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: exam_submissions submission_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
COPY public.employee (emp_id, emp_name, dept_id, salary) FROM stdin;
1	Alice	1	50000.00
2	Bob	2	60000.00
...
COPY public.employee_project (emp_id, project_id) FROM stdin;
1	1
2	1
2	2
3	2
...
COPY public.exam_questions (question_id, difficulty, question_text, expected_sql) FROM stdin;
1	easy	Liệt kê tất cả các phòng ban	SELECT * FROM department ORDER BY dept_id;
2	easy	Liệt kê tất cả nhân viên	SELECT * FROM employee ORDER BY emp_id;
3	easy	Tìm tên và lương của nhân viên trong phòng IT	SELECT emp_name, salary FROM employee e JOIN department d ON e.dept_id = d.dept_id WHERE d.dept_name = 'IT' ORDER BY emp_id;
4	easy	Liệt kê tất cả các dự án	SELECT * FROM project ORDER BY project_id;
6	medium	Tìm phòng ban có nhiều nhân viên nhất	SELECT dept_name FROM department d JOIN employee e ON d.dept_id = e.dept_id GROUP BY dept_name ORDER BY COUNT(*) DESC LIMIT 1;
7	medium	Tính tổng lương của mỗi phòng ban	SELECT dept_name, SUM(salary) AS total_salary FROM department d JOIN employee e ON d.dept_id = e.dept_id GROUP BY dept_name ORDER BY dept_name;
8	medium	Liệt kê nhân viên và các dự án họ tham gia	SELECT e.emp_name, p.project_name FROM employee e JOIN employee_project ep ON e.emp_id = ep.emp_id JOIN project p ON ep.project_id = p.project_id ORDER BY e.emp_id, p.project_id;
9	medium	Tìm dự án có ngân sách lớn hơn 25000	SELECT project_name FROM project WHERE budget > 25000 ORDER BY project_id;
11	hard	Tìm nhân viên tham gia tất cả các dự án	SELECT emp_name FROM employee e WHERE NOT EXISTS (SELECT p.project_id FROM project p EXCEPT SELECT ep.project_id FROM employee_project ep WHERE ep.emp_id = e.emp_id) ORDER BY emp_id;
12	hard	Tìm dự án có nhiều nhân viên tham gia nhất	SELECT project_name FROM project p JOIN employee_project ep ON p.project_id = ep.project_id GROUP BY project_name ORDER BY COUNT(*) DESC LIMIT 1;
13	hard	Tìm nhân viên có lương cao hơn trung bình của phòng ban họ	SELECT emp_name FROM employee e WHERE salary > (SELECT AVG(salary) FROM employee WHERE dept_id = e.dept_id) ORDER BY emp_id;
14	hard	Tìm tổng ngân sách các dự án mà phòng IT tham gia	SELECT SUM(budget) FROM project p JOIN employee_project ep ON p.project_id = ep.project_id JOIN employee e ON ep.emp_id = e.emp_id JOIN department d ON e.dept_id = d.dept_id WHERE d.dept_name = 'IT';
5	easy	Tìm tên nhân viên tham gia dự án Website Redesign	SELECT emp_name FROM employee e\nJOIN employee_project ep ON e.emp_id = ep.emp_id\nJOIN project p ON ep.project_id = p.project_id\nWHERE p.project_name = 'Website Redesign'\nORDER BY e.emp_id;
10	medium	Đếm số dự án mỗi nhân viên tham gia	SELECT emp_name, COUNT(project_id) AS total_projects\nFROM employee e\nJOIN employee_project ep ON e.emp_id = ep.emp_id\nGROUP BY emp_name, e.emp_id\nORDER BY e.emp_id;
15	hard	Tìm tên nhân viên và tên phòng ban của họ, chỉ lấy các nhân viên tham gia ít nhất 2 dự án	SELECT e.emp_name, d.dept_name\nFROM employee e\nJOIN department d ON e.dept_id = d.dept_id\nJOIN employee_project ep ON e.emp_id = ep.emp_id\nGROUP BY e.emp_name, d.dept_name, e.emp_id\nHAVING COUNT(ep.project_id) >= 2\nORDER BY e.emp_id;
\.
...
COPY public.exam_submissions (submission_id, student_id, question_id, submitted_sql, score, submitted_at) FROM stdin;
1	1755614472934284	1	SELECT * FROM department;	1.00	2025-08-19 14:41:13.222309
2	1755614472934284	2	SELECT * FROM employee;	1.00	2025-08-19 14:41:13.222309
3	1755614472934284	4	SELECT * FROM project;	1.00	2025-08-19 14:41:13.222309
7	1755614925960924	1	SELECT * FROM department;	1.00	2025-08-19 14:48:46.358934
8	1755614966007313	1	SELECT * FROM department;	1.00	2025-08-19 14:49:25.307384
9	1755614966007313	2	SELECT * FROM employee;	1.00	2025-08-19 14:49:25.307384
12	1755615342114989	1	SELECT * FROM department;	1.00	2025-08-19 14:55:41.935922
14	175561551945415	1	SELECT * FROM department;	1.00	2025-08-19 14:58:39.691909
15	175561551945415	2	SELECT * FROM employee;	1.00	2025-08-19 14:58:39.691909
16	\N	1	SELECT * FROM department;	1.00	2025-08-19 15:05:33.072711
17	\N	2	SELECT * FROM employee;	1.00	2025-08-19 15:05:33.072711
18	307	1	SELECT * FROM department;	1.00	2025-08-21 03:10:46.457036
19	307	4	SELECT * FROM project;	1.00	2025-08-21 03:10:46.457036
20	518	1	SELECT * FROM department;	1.00	2025-08-21 06:12:32.330026
21	232	1	SELECT * FROM department;	1.00	2025-08-21 07:20:31.709292
22	799	1	SELECT * FROM department;	1.00	2026-01-21 14:58:41.518532
23	799	13	SELECT	0.00	2026-01-21 14:58:41.518532
\.
...
COPY public.project (project_id, project_name, budget) FROM stdin;
1	Website Redesign	20000.00
2	Mobile App	30000.00
3	ERP System	50000.00
\.
...
SELECT pg_catalog.setval('public.department_dept_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.employee_emp_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.exam_questions_question_id_seq', 15, true);


--
-- Name: exam_submissions_submission_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.exam_submissions_submission_id_seq', 23, true);
...
ALTER TABLE ONLY public.employee_project
    ADD CONSTRAINT employee_project_pkey PRIMARY KEY (emp_id, project_id);
...
--
-- Name: employee employee_dept_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employee
    ADD CONSTRAINT employee_dept_id_fkey FOREIGN KEY (dept_id) REFERENCES public.department(dept_id);


--
-- Name: employee_project employee_project_emp_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employee_project
    ADD CONSTRAINT employee_project_emp_id_fkey FOREIGN KEY (emp_id) REFERENCES public.employee(emp_id);
...
ALTER TABLE ONLY public.employee_project
    ADD CONSTRAINT employee_project_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.project(project_id);


--
-- Name: exam_submissions exam_submissions_question_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.exam_submissions
    ADD CONSTRAINT exam_submissions_question_id_fkey FOREIGN KEY (question_id) REFERENCES public.exam_questions(question_id);


--
-- Name: DATABASE exam; Type: ACL; Schema: -; Owner: postgres
--

GRANT CONNECT ON DATABASE exam TO student_exam;
...
GRANT USAGE ON SCHEMA public TO student_exam;
...
GRANT SELECT ON TABLE public.department TO student_exam;
...
GRANT SELECT ON TABLE public.employee TO student_exam;


--
-- Name: TABLE employee_project; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.employee_project TO student_exam;
...
GRANT SELECT ON TABLE public.exam_questions TO student_exam;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.exam_submissions TO student_exam;


--
-- Name: SEQUENCE exam_submissions_submission_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.exam_submissions_submission_id_seq TO student_exam;
...
GRANT SELECT ON TABLE public.project TO student_exam;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT SELECT ON TABLES TO student_exam;
...
\restrict Wt4hRSjB5SrV35EYnUEB2AIT4RUeH4evTSWpC7W8f2ArbnyPLZYHEnXgLIy4N5J
...
COPY public.positions (id, title, base_salary) FROM stdin;
1	Nhân viên	8000000.00
2	Trưởng phòng	15000000.00
3	Giám đốc	30000000.00
\.
...
\unrestrict Wt4hRSjB5SrV35EYnUEB2AIT4RUeH4evTSWpC7W8f2ArbnyPLZYHEnXgLIy4N5J

--
-- Database "w3school" dump
--
...
\restrict 4jGn4YfLepDOTDzGCxxumFo8Jfnc13ULaVEhtc2OegJlDAuAthzaxrGjnCeilaf
...
--
-- Name: w3school; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE w3school WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE w3school OWNER TO postgres;

\unrestrict 4jGn4YfLepDOTDzGCxxumFo8Jfnc13ULaVEhtc2OegJlDAuAthzaxrGjnCeilaf
\connect w3school
\restrict 4jGn4YfLepDOTDzGCxxumFo8Jfnc13ULaVEhtc2OegJlDAuAthzaxrGjnCeilaf
...
CREATE TABLE public.orders (
    ...
    orderdate date,
    shipperid character varying(10)
);
...
COPY public.employees (employeeid, lastname, firstname, birthdate, photo, notes) FROM stdin;
...
COPY public.orders (orderid, customerid, employeeid, orderdate, shipperid) FROM stdin;
...
COPY public.products (productid, productname, supplierid, categoryid, unit, price) FROM stdin;
...
COPY public.suppliers (supplierid, suppliername, contactname, address, city, postalcode, country, phone) FROM stdin;
...
--
-- Name: DATABASE w3school; Type: ACL; Schema: -; Owner: postgres
--

GRANT CONNECT ON DATABASE w3school TO readonly_user;
...
GRANT SELECT ON TABLE public.employees TO readonly_user;
...
GRANT SELECT ON TABLE public.orderdetails TO readonly_user;
...
GRANT SELECT ON TABLE public.products TO readonly_user;
...
GRANT SELECT ON TABLE public.shippers TO readonly_user;
...
GRANT SELECT ON TABLE public.suppliers TO readonly_user;
